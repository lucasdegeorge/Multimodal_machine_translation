...
def mixed_train(val_data_en,val_data_fr,inv_map_en,inv_map_fr,model_fr,model_en,train_data_fr,train_data_en,n_iter,batch_size, image_bool = False,part_auto_encoding = 1/2):
    loss_list = []
    liveloss= PlotLosses()
