...
>>>>>>> main
    ...
    def forward(
        ...
        scores_e, attn_weights_e = self.attention(
            q,
            k_e,
            v_e,
            self.d_k,
        ...
        scores_i, attn_weights_i = self.attention(
            q, k_i, v_i, self.d_k, None, None, self.dropout, only_image=True
        )
        ...
        scores_ei, attn_weights_ei = self.attention(
            q,
            k_ei,
            v_ei,
            self.d_k,
...
>>>>>>> main
        ...
        return (
            ...
            attn_weights_e,
            attn_weights_i,
        )  # Pourquoi on ne renvoie pas attn_weights_ei ????

    def attention(
        self, q, k, v, d_k, mask=None, padding_mask=None, dropout=None, only_image=False
    ):
